dim1 = 3;
fftLen = coeffCollection{dim1}.fftLen;
hop = coeffCollection{dim1}.hop;
oct = coeffCollection{dim1}.oct;
halfLen = fftLen / 2 + 1;
HFSamplingLimit = coeffCollection{dim1}.HFSamplingLimit;
order = 2;
...
coeff = coeffCollection{dim1}.coeff;
f_q = coeffCollection{dim1}.f_q;
sparCutOff = 2e-7;

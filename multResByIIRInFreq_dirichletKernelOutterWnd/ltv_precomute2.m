...
%     pack.target = target;
%     sigs{idx} = pack;
%     extRe = [sigs{idx}.SRe(prepad + 1 : -1 : 2, :); sigs{idx}.SRe; sigs{idx}.SRe(halfLen - 1 : -1 : (halfLen - pospad + 1), :)];
%     extIm = [-sigs{idx}.SIm(prepad + 1 : -1 : 2, :); sigs{idx}.SIm; -sigs{idx}.SIm(halfLen - 1 : -1 : (halfLen - pospad + 1), :)];
%     sigs{idx}.SRe = extRe;
%     sigs{idx}.SIm = extIm;
% end
